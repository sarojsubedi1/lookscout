...
const ThinkOutside = () => {
  return (
    <section className="px-4 py-8 flex flex-col gap-10 lg:flex-row">
      <div className="flex-1 flex flex-col gap-10">
        <h1 className="text-[28px] text-[#272D37] font-semibold leading-9 tracking-tight">
        ...
        <div>
          <button className="flex gap-2 bg-[#437EF7] text-[15px] text-white font-semibold px-[18px] py-3 rounded-lg">
            <p>Start now</p>
            <Image alt="check" src={CheckWhite} />
          </button>
        </div>
      </div>
