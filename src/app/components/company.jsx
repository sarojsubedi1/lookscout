...
const Company = () => {
  return (
    <>
      <div className="bg-[#2B63D9] px-[16px] py-[32px] text-white text-center flex flex-col gap-[16px]">
        ...
        <div>
          <button className="bg-white text-[#2B63D9] w-full rounded px-[18px] py-[12px]">
            Sign Up
          </button>
        </div>
        <div>
          <button className="text-white bg-[#437EF7] w-full rounded px-[18px] py-[12px]">
            Sign In
          </button>
        </div>
      </div>
      <div className="bg-[#2B63D9] px-[16px] py-[32px] flex flex-col gap-[32px]">
